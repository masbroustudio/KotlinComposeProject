...
sealed class BottomNavItem(var title: String, var icon: Int, var screen_route: String) {
    ...
    object Favorite : BottomNavItem(
        "Favorite", R.drawable.ic_baseline_favorite_border_24,
        FAVORITE_SCREEN
    )

    object AboutMe : BottomNavItem("About", R.drawable.baseline_person_fill_white, ABOUT_SCREEN)
}
